...
<div class="container mt-3">
    ...
    <div class="row">
        <div class="col-md-7">
            ...
            <p>
                <strong>Ecrire</strong> le code d'Agorakit, le tester et le <strong>faire évoluer</strong> prend beaucoup de temps.
            </p>
            <p>
                Vous avez envie de <strong>soutenir le projet</strong>? Votre groupe <strong>utilise régulièrement</strong> <a href="https://app.agorakit.org" target="_blank">l'Agora partagée</a>? Ou vous utilisez Agorakit dans un autre cadre et <strong>voulez le voir évoluer plus rapidement?</strong>
            </p>
            <p>
                Vous pensez qu'il est important <strong>d'offrir des espaces de collaboration libres</strong>, non propriétaires et respectueux de la vie privée?
            </p>



            <p><strong>Votre don, petit ou grand, va soutenir le projet : merci!</strong></p>

            <p class="font-italic">PS :  si vous avez des questions, regardez plus bas dans la page</p>
