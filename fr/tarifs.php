    ...
    <div class="card-deck mb-3 text-center align-self-stretch">
        ...
        <div class="pricing-card card mb-4 shadow">
            ...
            <div class="card-footer">
                <a href="https://github.com/agorakit/agorakit" type="button" class="btn btn-lg btn-block btn-outline-primary" target="_blank">Projet Github</a>
            </div>
        </div>
        ...
        <div class="pricing-card card mb-4 shadow">
            ...
            <div class="card-footer">
                <a href="mailto:info@agorakit.org" class="btn btn-lg btn-block btn-primary mt-2" role="link">Contactez-nous</a>
            </div>
        </div>
