...
<div class="container mt-3">
    ...
    <div class="row">
        <div class="col-md-7">
            ...
            <h1 class="text-center mb-4">A platform for everyone</h1>

            <h2 class="sub text-center mb-5">Want to support the project? Thank you!</h2>
            ...
            <p><strong>Your donation, big or small will help the project : thank you!</strong></p>

            <!--<p class="font-italic">PS :  if you have questions look bellow</p>-->
